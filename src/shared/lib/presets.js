...
export const presets = [
  ...
  { name: "Max", domain: "max.com", price: 18.49, cycle: "Monthly", color: "purple", category: "Streaming" },
  ...
  { name: "Adobe Creative Cloud", domain: "adobe.com", price: 59.99, cycle: "Monthly", color: "rose", category: "Productivity" },
